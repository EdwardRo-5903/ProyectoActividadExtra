...
var nombre = prompt("Ingrese su nombre, por favor, si desea cerrar escriba salir");
...
var propiedades = parseInt(prompt("Ingrese la cantidad de propiedades que tiene:"));

var recargo_pro = propiedades * (precio_base * 0.35);

var salario = parseInt(prompt("Ingrese su salario actual")); 

var recargo_sal = (salario * 0.05);
...
precio_final = precio_base + recargo_total + recargo_hijos + recargo_pro + recargo_sal;

// Resultado
alert("Para el asegurado " + nombre);
alert("El recargo total será de: " + recargo_total + ", " + recargo_pro + ", " + recargo_sal + ", " + " y " + recargo_hijos);
